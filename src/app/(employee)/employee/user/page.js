...
export function UserModal({ userData, closeWindow, fetchUsers }) {
    ...
    const deductCoins = async () => {
        ...
        let req = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/api/emp/deductCoinsFromUser`, {
            method: "POST",
            headers: {
    ...
    const addCoins = async () => {
        ...
        let req = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/api/emp/addCoinsToUser`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${empToken}`,   // send token in header
...
function UserEmpPage() {
    ...
    const fetchTotalUsers = async () => {
        try {
            ...
            if (!empToken) throw new Error("No admin token found");

            const res = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/api/emp/totalUsersDetails`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${empToken}`,   // send token in header
    ...
    const addUser = async () => {
        ...
        const req = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/api/emp/createUser`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${empToken}`,   // send token in header
