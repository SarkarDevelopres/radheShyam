...
class HLCanvas {
    ...
    _computeLayout(w, h) {
        ...
        this.slotA.y = padding + (cardH / 3.5);

        this.slotB.x = padding + perSlotW + gap + (perSlotW - cardW) / 2;
        this.slotB.y = padding + (cardH / 3.5);
    ...
    render() {
        ...
        this._label("Dragon", this._labelA.x, this._labelA.y);
        this._label("Tiger", this._labelB.x, this._labelB.y);
    }
}
